...
4. Explore options for avoiding the need to compile streams before grouping.  (See [v2 diagram](docs/v2/dupfind-cats-effect.svg) example and also todo comment in [Dupfind.scala](src/main/scala/org/dupfind/cats/effect/Dupfind.scala))
